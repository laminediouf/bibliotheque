...
if(isset($_GET['ID'])){
$req="SELECT ID,prenom,nom,pays,datenaissance,datedisparu FROM auteur WHERE ID='".$_GET['ID']."'";
...
<tr>
  ...
  <td> <?php echo $recup['datenaissance'];?> </td>
</tr>
<tr>
  <th>DATE PUBLICATION</th>
  <td> <?php echo $recup['datedisparu'];?> </td>
</tr>
</table>
